...
class MySearchGooglePlacesWidget extends StatefulWidget {
  const MySearchGooglePlacesWidget({
...
class _SearchMapPlaceWidgetState extends State<MySearchGooglePlacesWidget>
